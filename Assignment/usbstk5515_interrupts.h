...
#define TCR1		*((ioport volatile Uint16*)0x1850)//Timer Control Register
#define TPR1_1		*((ioport volatile Uint16*)0x1852)//Timer Period Register 1
#define TPR1_2		*((ioport volatile Uint16*)0x1853)//Timer Period Register 2
#define TCR1_1		*((ioport volatile Uint16*)0x1854)//Timer Counter Register 1
#define TCR1_2		*((ioport volatile Uint16*)0x1855)//Timer Counter Register 2
#define T_INT_1		*((ioport volatile Uint16*)0x1856)//Timer Interrupts register
//General Purpose Timer 2
#define TCR2		*((ioport volatile Uint16*)0x1890)//Timer Control Register
#define TPR2_1		*((ioport volatile Uint16*)0x1892)//Timer Period Register 1
#define TPR2_2		*((ioport volatile Uint16*)0x1893)//Timer Period Register 2
#define TCR2_1		*((ioport volatile Uint16*)0x1894)//Timer Counter Register 1
#define TCR2_2		*((ioport volatile Uint16*)0x1895)//Timer Counter Register 2
#define T_INT_2		*((ioport volatile Uint16*)0x1896)//Timer Interrupts register
